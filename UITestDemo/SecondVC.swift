...
extension OnBoardingVC: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            cell.config(mediumTitle: "", largeTitle: "", subTitle: "", image: UIImage(named: "img_Onboarding_1"))
        case 1:
            cell.config(mediumTitle: "", largeTitle: "", subTitle: "", image: UIImage(named: "img_Onboarding_2"))
        case 2:
            cell.config(mediumTitle: "", largeTitle: "", subTitle: "", image: UIImage(named: "img_Onboarding_3"))
        default: break
        }
        return cell
